...
class SalesClass:
    def __init__(self,root):
        ...
        self.Sales_List.bind("<ButtonRelease-1>",self.get_date)

        #area
        bill_Frame=Frame(self.root,bd=3,relief=RIDGE)
        bill_Frame.place(x=280,y=140,width=500,height=520)

        lbl_title2 = Label(bill_Frame, text="Customer Bills Area",bg="orange").pack(side=TOP, fill=X)
